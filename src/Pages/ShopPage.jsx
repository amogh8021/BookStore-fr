  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        ...
        if (isBestSeller) {
          res = await axios.get("http://localhost:8080/book/best-sellers", {
            params: { limit: size },
          });
          setBooks(res.data);
          setTotalPages(1);
          ...
          res = await axios.get("http://localhost:8080/book/search", { params });
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 min-h-screen flex flex-col md:flex-row p-4 md:p-12 gap-6">
        ...
        {/* Sidebar Filters */}
        <div
          className={`bg-white p-4 rounded-lg shadow-md md:w-64 flex-shrink-0 transition-transform ${
        ...
        <div className="flex-1">
          ...
          {!isBestSeller && (
            <div className="flex justify-center mt-6 gap-3">
              ...
              <span className="px-4 py-2 font-semibold">Page {page + 1} of {totalPages}</span>
              <button
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 relative p-6 animate-fadeIn">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <button onClick={() => handleAddToCart(selectedBook)} className="bg-blue-600 text-white px-5 py-2 rounded-xl hover:bg-blue-700 transition-all duration-200">
                    Add to Cart
                  </button>
                </div>
              </div>
